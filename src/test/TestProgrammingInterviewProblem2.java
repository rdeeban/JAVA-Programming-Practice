...
import main.ProgrammingInterviewProblem2;
import org.junit.Test;

import java.util.List;
import java.util.Arrays;

public class TestProgrammingInterviewProblem2 {
    ...
    public void testProblem2InvalidInputNoDuplicateNumberInArrayOfSizeFour() {
        ...
        Throwable exception = assertThrows(IllegalArgumentException.class,
                () -> ProgrammingInterviewProblem2.findDuplicateNumber(prob2Arr));
    ...
    public void testProblem2DuplicateNumberInSecondPositionAndDuplicatedNumberRightBeforeInArrayOfSizeFour() {
        ...
        int duplicateNum = ProgrammingInterviewProblem2.findDuplicateNumber(prob2Arr);
